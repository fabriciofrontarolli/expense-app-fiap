...
class AdicionarDespesa : BaseActivity(), OnDateSetListener, OnTimeSetListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (user.isLoggedIn) {
            ...
            Toast.makeText(this@AdicionarDespesa, "Please login", Toast.LENGTH_LONG).show()
            val intent = Intent(this@AdicionarDespesa, LoginForm::class.java)
        ...
        (expenseTimestampText as EditText).setOnClickListener{
            ...
            val datePickerDialog = DatePickerDialog(this@AdicionarDespesa, this@AdicionarDespesa, year, month, day)
    ...
    override fun onDateSet(view: DatePicker?, yearSelected: Int, monthSelected: Int, dayOfMonthSelected: Int) {
        ...
        val timePickerDialog = TimePickerDialog(this@AdicionarDespesa, this@AdicionarDespesa, hour, minute, DateFormat.is24HourFormat(this))
            ...
            client.useDataService()
                    ...
                    .enqueue(object : Callback<InsertExpenseResult, HasuraException> {
                        override fun onSuccess(p0: InsertExpenseResult?) {
                            ...
                            startActivity(Intent(this@AdicionarDespesa, ViewExpense::class.java))
                        }
